...
df=pd.read_csv(r"C:\Users\Laptop Solutions\Documents\Full-Stack-AI-Bootcamp-B-11\FinalAssessment\SalesforceStock\Salesforce (CRM) From 2004 To Dec-2024.csv")
print(df.head(5))
print(df.info())
